        ...
        >
          ...
          <VStack spacing="8">
            ...
            <SimpleGrid minChildWidth="240px" spacing={["6", "8"]} w="100%">
              <Input type="name" label="Nome completo" {...register('name')} error={errors?.name} />
            ...
            <SimpleGrid minChildWidth="240px" spacing={["6", "8"]} w="100%">
              ...
              <Input type="password_confirmation" label="Confirmação da senha" {...register('password_confirmation')} error={errors?.password_confirmation} />
            </SimpleGrid>
